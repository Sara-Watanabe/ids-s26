...
**Step 4.**  Steps 2 and 3 are repeated until growth-stop conditions are met. These include a maximum depth of the tree, minimum number of samples required to split a node, and minimum reduction in the Gini Coefficient required to split a node. The lower the Gini value the better
