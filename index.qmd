...
For those interested, class notes from [Fall 2025](https://statds.github.io/ids-f25), [Spring 2025](https://statds.github.io/ids-s25), [Fall 2024](https://statds.github.io/ids-f24), [Spring 2024](https://statds.github.io/ids-s24), [Spring 2023](https://statds.github.io/ids-s23), and [Spring 2022](https://statds.github.io/ids-s22/) are publicly accessible. These archives offer insights into the evolution of the course content and the different perspectives brought by successive student cohorts.
...
To reproduce the classnotes output on your own computer, here are the necessary steps. See Section @sec-buildnotes for details.

-   Clone the classnotes repository to an appropriate location on your computer; see Chapter @sec-git for using Git.
-   Set up a Python virtual environment in the root folder of the source; see Section @sec-python-venv.
...
TBD <!-- Reproduce NYC street flood research [@agonafir2022machine;
...
-   [ASA Data Challenge Expo](https://community.amstat.org/dataexpo/home): What works in education?
-   [Kaggle](https://www.kaggle.com).
-   [DrivenData](https://www.drivendata.org).
-   [15 Data Science Hackathons to Test Your Skills](https://www.fynd.academy/blog/data-science-hackathons)
-   [openFDA](https://open.fda.gov)
-   If you work on sports analytics, you are welcome to submit a poster to [Connecticut Sports Analytics Symposium (CSAS) 2026](https://statds.org/events/csas2026/). A good resource for sports analytics is [ScoreNetwork](https://scorenetwork.org).
-   [Paleobiology Database](https://paleobiodb.org/#/).

## Adapting to Rapid Skill Acquisition

In this course, students are expected to rapidly acquire new skills, a critical aspect of data science. To emphasize this, consider this insightful quote from @vanderplas2016python:
...
+ Watanabe, Sara
    ...
    - To learn how to manage projects through GitHub and VS Code effectively
+ Wolven, Alexander
+ Zhang, Jianan
...
-   Markdown jumpstart <!-- + Effective data science communication -->
-   Import/Export data
-   Data manipulation with `Pandas`
-   Accessing US census data <!-- + Arrow as a cross-platform data format -->
...
-   LLM agents <!-- + TensorFlow -->
-   Automatic differentiation
-   Reinforcement learning
-   Developing a Python package
-   Web scraping <!-- + Personal webpage on GitHub
...
Please use the following table to sign up.
  ...
  ----- | ------------- | ------------------------- 
   02/16 | Last, First  | Selected topic
   02/16 | Last, First  | Selected topic   
   02/18 |  |
...
We use the same order as the topic presentation for undergraduate final presentation. An [introduction on how to use Quarto to prepare presentation slides](https://github.com/statds/ids-s26/blob/main/templates/presentation.qmd) is available under the `templates` directory in the classnotes source tree, thank to Zachary Blanchard, which can be used as a template to start with.
...
For more detailed style guidance, please see notes on [statistical writing](https://ohyoo.github.io/UConn-STAT-Writing/).

Plagiarism is to be prevented. Remember that these class notes are publicly available online with your names attached. Here are some resources on [how to avoid plagiarism](https://usingsources.fas.harvard.edu/how-avoid-plagiarism).
...
-   For standalone pdf output, you will need to have [LaTeX](https://www.latex-project.org/get/) installed.
...
-   Would you use CLI and GUI? <!-- + How many students will present at 2025 NYC ODW and when will the --> <!--   presentations be? -->
